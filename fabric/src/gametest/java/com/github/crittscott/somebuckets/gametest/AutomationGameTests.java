...
public final class AutomationGameTests {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_assigned_source_takes_matching_world_source(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_stacked_empty_mob_buckets_settle_one_result_and_release_it(GameTestHelper helper) {
        AutomationScenarios.dispenser_stacked_empty_mob_buckets_settle_one_result_and_release_it(helper);
    }

    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_stacked_empty_buckets_settle_each_bucket_family(GameTestHelper helper) {
        AutomationScenarios.dispenser_stacked_empty_buckets_settle_each_bucket_family(helper);
    }

    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_full_inventory_ejects_stacked_bucket_result(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_mob_bucket_releases_second_aquatic_entity_after_front_is_cleared(GameTestHelper helper) {
