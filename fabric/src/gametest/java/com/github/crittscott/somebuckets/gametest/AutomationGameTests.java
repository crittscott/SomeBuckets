...
public final class AutomationGameTests {
    ...
    public void dispenser_big_bucket_collects_world_source(GameTestHelper helper) {
        ...
        helper.runAfterDelay(8L, () -> {
            GameTestSupport.check(dispenser.getItem(0).is(FabricItems.BIG_BUCKET_8),
    ...
    public void dispenser_huge_bucket_collects_world_source(GameTestHelper helper) {
        ItemStack bucket = new ItemStack(FabricItems.BIG_BUCKET_64);
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
        ...
        GameTestSupport.triggerDispenser(helper, DISPENSER);
        helper.runAfterDelay(8L, () -> {
            GameTestSupport.check(dispenser.getItem(0).is(FabricItems.BIG_BUCKET_64),
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_fluid_does_not_fall_through_solid_front_block(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_powder_does_not_fall_through_solid_front_block(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_source_does_not_fall_through_solid_front_block(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_big_bucket_round_trips_powder_snow(GameTestHelper helper) {
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
                helper, DISPENSER, Direction.EAST, GameTestSupport.big8());
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_big_bucket_round_trips_full_cauldron(GameTestHelper helper) {
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
                helper, DISPENSER, Direction.EAST, GameTestSupport.big8());
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_source_round_trips_cauldron_without_consumption(GameTestHelper helper) {
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_collects_but_does_not_place_powder_cauldron(GameTestHelper helper) {
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
                helper, DISPENSER, Direction.EAST, GameTestSupport.big8());
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_source_places_repeatedly_without_consumption(GameTestHelper helper) {
    ...
    public void dispenser_empty_source_milks_adult_cow(GameTestHelper helper) {
        ...
        GameTestSupport.triggerDispenser(helper, DISPENSER);
        helper.runAfterDelay(8L, () -> {
            GameTestSupport.check(dispenser.getItem(0).is(FabricItems.SOURCE_BUCKET),
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_empty_mob_bucket_captures_one_entity(GameTestHelper helper) {
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(
        ...
        GameTestSupport.triggerDispenser(helper, DISPENSER);
        helper.runAfterDelay(8L, () -> {
            GameTestSupport.check(dispenser.getItem(0).is(FabricItems.MOB_BUCKET),
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_nonempty_mob_bucket_captures_matching_entity(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_full_mob_bucket_does_nothing_when_matching_mob_occupies_front(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.mob();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_nonempty_mob_bucket_releases_entity(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.mob();
        addPigSnapshot(helper, bucket);
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(helper, DISPENSER, Direction.EAST, bucket);
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_mob_bucket_releases_aquatic_entity_with_water(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.mob();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_mob_bucket_releases_second_aquatic_entity_after_front_is_cleared(
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_nonempty_mob_bucket_does_not_capture_another_entity(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.mob();
        addPigSnapshot(helper, bucket);
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(helper, DISPENSER, Direction.EAST, bucket);
        Cow cow = GameTestSupport.spawn(helper, EntityType.COW, FRONT);
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_junk_bucket_absorbs_and_merges_front_items(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_full_junk_bucket_does_not_eject_when_input_is_blocked(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.junk();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_trash_bucket_replaces_one_front_item(GameTestHelper helper) {
        ...
        GameTestSupport.triggerDispenser(helper, DISPENSER);
        helper.runAfterDelay(8L, () -> {
            GameTestSupport.check(dispenser.getItem(0).is(FabricItems.TRASH_BUCKET),
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_junk_bucket_feeds_one_adult_animal(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.junk();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_feeding_precedes_item_collection(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.junk();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_junk_bucket_grows_one_baby_animal(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.junk();
        NBTUtil.setStoredItems(bucket, List.of(new ItemStack(Items.CARROT, 2)));
        DispenserBlockEntity dispenser = GameTestSupport.dispenser(helper, DISPENSER, Direction.EAST, bucket);
        Pig pig = GameTestSupport.spawn(helper, EntityType.PIG, FRONT);
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_animal_blocks_junk_bucket_output_when_it_cannot_be_fed(GameTestHelper helper) {
        ItemStack bucket = GameTestSupport.junk();
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.WORLD_TIMEOUT)
    public void dispenser_claim_denial_preserves_every_automation_path(GameTestHelper helper) {
