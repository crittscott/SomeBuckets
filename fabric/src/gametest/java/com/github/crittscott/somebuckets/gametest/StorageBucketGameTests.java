...
public final class StorageBucketGameTests {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.SHORT_TIMEOUT)
    public void junk_bucket_world_collect_is_bounded_by_pickup_radius(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.SHORT_TIMEOUT)
    public void junk_bucket_respects_item_target_and_records_pickup(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.SHORT_TIMEOUT)
    public void junk_bucket_screen_insert_and_fifo_extract(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.SHORT_TIMEOUT)
    public void junk_bucket_inventory_prediction_is_deterministic(GameTestHelper helper) {
    ...
    @GameTest(template = GameTestSupport.TEMPLATE, timeoutTicks = GameTestSupport.SHORT_TIMEOUT)
    public void storage_eligibility_rule_accepts_buckets_and_refuses_containers(GameTestHelper helper) {
