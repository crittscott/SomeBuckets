...
public final class PresentationGameTests {
    ...
    public void dynamic_bucket_names_match_registered_identity_and_language(GameTestHelper helper) {
        ...
        assertFiniteNames(FabricItems.BIG_BUCKET_8, "item.somebuckets.big_bucket_8", "Big", expectedNames);
        assertFiniteNames(FabricItems.BIG_BUCKET_64, "item.somebuckets.big_bucket_64", "Huge", expectedNames);
    ...
    public void model_predicates_match_java_protocol(GameTestHelper helper) {
        ItemStack empty = new ItemStack(FabricItems.BIG_BUCKET_8);
        assertFloat(FluidBucketItem.getContentProperty(empty), FluidBucketItem.CONTENT_EMPTY, "empty BB predicate");

        ItemStack fluid = GameTestSupport.fluid(
                new ItemStack(FabricItems.BIG_BUCKET_8), Fluids.WATER, FluidBucketItem.BUCKET_VOLUME_MB);
        assertFloat(FluidBucketItem.getContentProperty(fluid), FluidBucketItem.CONTENT_FLUID, "fluid BB predicate");

        ItemStack milk = new ItemStack(FabricItems.BIG_BUCKET_8);
        ...
        ItemStack powder = new ItemStack(FabricItems.BIG_BUCKET_8);
        ...
        assertModelPredicates("models/item/source_bucket.json", FluidBucketItem.CONTENT_PROPERTY,
                FluidBucketItem.CONTENT_FLUID, FluidBucketItem.CONTENT_MILK);
    ...
    private static void assertSourceNames(Map<String, String> expectedNames) {
        Item item = FabricItems.SOURCE_BUCKET;
    ...
    private static void assertFluidName(Item item, net.minecraft.world.level.material.Fluid fluid,
                                        String expectedKey) {
        ItemStack stack = GameTestSupport.fluid(new ItemStack(item), fluid, FluidBucketItem.BUCKET_VOLUME_MB);
    ...
    private static JsonObject readJson(String path) {
        ...
        try (InputStream input = PresentationGameTests.class.getResourceAsStream(resourcePath)) {
