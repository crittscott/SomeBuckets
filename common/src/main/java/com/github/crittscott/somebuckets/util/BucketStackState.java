 ...
 * vanilla {@code minecraft:max_stack_size} and {@code minecraft:consumable} components
 * {@code BucketState} maintains alongside them, along with the stack count. Used to settle a working
 * copy back onto the real stack a Transfer API transaction or a held transfer operates on.
 */
