 ...
 *
 * <p>Loader-specific optional-integration bootstrap (deciding which providers to register, such as
 * FTB Chunks) is not this class's job; each loader entrypoint calls {@link #register} directly for
 * whatever optional integrations it finds loaded.
 */
